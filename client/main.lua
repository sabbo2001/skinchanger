local Components = {
	...
	{label = _U('watches_1'),         		name = 'watches_1',    value = 0, min = 0, zoomOffset = 0.75, camOffset = 0.15}, --
	{label = _U('watches_2'),         		name = 'watches_2',    value = 0, min = 0, zoomOffset = 0.75, camOffset = 0.15, textureof = 'glasses_1'}, --
	{label = _U('bracelets_1'),         		name = 'bracelets_1',    value = 0, min = 0, zoomOffset = 0.75, camOffset = 0.15}, --
	{label = _U('bracelets_2'),         		name = 'bracelets_2',    value = 0, min = 0, zoomOffset = 0.75, camOffset = 0.15, textureof = 'glasses_1'}, --
